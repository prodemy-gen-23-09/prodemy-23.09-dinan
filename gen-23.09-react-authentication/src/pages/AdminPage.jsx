  ...
  return (
    <div className="flex flex-col gap-24 items-center">
      ...
      <Modal isVisible={showModal} onClose={setShowModal}>
        <Form typeSubmit="onSubmitNewData" text={"Input New Product"} />
      </Modal>
      <Modal isVisible={showModalUpdate} onClose={setShowModalUpdate}>
        <Form dataProduct={id != null ? data.filter((list) => list.id == id)[0] : id} typeSubmit="onUpdateData" text={"Update Product"} />
      </Modal>
    </div>
  )
}
