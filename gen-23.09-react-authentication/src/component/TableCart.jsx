          ...
          <tr key={list.id} className="border-2">
            ...
            <td>
              <div className="flex justify-center">
                <QuantityInTableCart quantity={list.quantity} id={list.id} />
              </div>
            </td>
            <td className="text-center">
            ...
            <td>
              <div className="flex justify-center">
                <Button custom="rounded w-16 text-xs font-medium" color="bg-red-600 hover:bg-red-700 text-white" onClick={() => dispatch(deleteFromCart(list.id))}>
                  Hapus
                </Button>
              </div>
            </td>
