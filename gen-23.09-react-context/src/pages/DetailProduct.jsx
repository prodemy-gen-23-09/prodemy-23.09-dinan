        ...
        <div className="container flex justify-center gap-8">
          ...
          <div className="flex flex-col justify-start gap-y-3 w-[500px]">
            ...
            <div className="flex items-center">
              ...
              <p className="text-xs">
                3.75 (2k rating){" "}
                <span className="text-orange-500 font-semibold ml-4">623 Reviews</span>
              </p>
            </div>
            <h1 className="font-bold text-2xl text-green-400">
              Rp. {JSON.parse(data.harga).toLocaleString("id-ID")}
            </h1>
            <p>Select Size</p>
            <div className="flex gap-3">
              {data.size.map((size, index) => (
                <Button
                  onClick={selectSize}
                  color="border-2 hover:border-2 hover:border-gray-500 w-8"
                  key={index}
                  value={size}
                  text={size}
                ></Button>
