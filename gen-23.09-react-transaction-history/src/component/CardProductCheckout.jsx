  ...
  return (
    <div className="flex gap-10 items-center shadow-lg p-3 min-w-max rounded-lg">
      <div className="flex items-center gap-3">
        <img src={data.product.image[0]} className="w-40 h-40"></img>
        <h1 className="font-semibold">{data.name}</h1>
      </div>
      <div className="flex-col text-center font-semibold">
        <h1>Harga satuan</h1>
        <h1 className="text-orange-400">{data.product.harga}</h1>
      </div>
      <div className="flex-col text-center font-semibold">
        <h1>Jumlah</h1>
      ...
      <div className="flex-col text-center font-semibold">
        <h1>Sub Total</h1>
        <h1 className="text-orange-400">Rp. {(data.product.harga * data.quantity).toLocaleString("ID-id")}</h1>
      </div>
      <div>
