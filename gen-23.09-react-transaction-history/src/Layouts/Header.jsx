  ...
  return (
    <header className="container flex justify-between p-3">
      ...
      <nav className="flex items-center gap-3">
        ...
        <Link to="/checkout" className="flex items-center gap-1 group">
          <h3 className="anchorHover">Checkout</h3>
        </Link>
        {user.role == "admin" && (
          <Link to="/transactionHistoty" className="flex items-center gap-1 group">
            <h3 className="anchorHover">Transaction Histoty</h3>
          </Link>
        )}
