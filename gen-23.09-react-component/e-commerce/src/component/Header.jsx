  ...
  <header className="container flex justify-between p-3">
    ...
    <nav className="flex items-center gap-3">
      <div className="flex items-center gap-1 group">
        <UserIcon className="h-6 w-6 group-hover:stroke-orange-400" />
        <a className="font-semibold group-hover:text-orange-400">Login</a>
      </div>
      <div className="flex items-center gap-1 group">
        <ShoppingCartIcon className="h-6 w-6 group-hover:stroke-orange-400" />
        <a className="font-semibold group-hover:text-orange-400">Cart</a>
      </div>
    </nav>
  </header>
)
